...
from ephyra.formula._native import calculate_screen_width_height, calculate_fov, convert_fov_to_aspect_ratio, \
...
class NScreenCalculationsTestCase(ScreenCalculationsTestCaseMixin, TestCase):
    calculate_screen_width_height = staticmethod(calculate_screen_width_height)


class NFOVManipulationTestCase(FOVManipulationTestCaseMixin, TestCase):
    calculate_fov = staticmethod(calculate_fov)
    convert_fov_to_aspect_ratio = staticmethod(convert_fov_to_aspect_ratio)


class NCalculatorFormulaTestCase(CalculatorFormulaTestCaseMixin, TestCase):
